...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register') }} * All fields required </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="number" min="0" max="150" class="form-control" name="age" value="{{ old('age') }}" required autofocus>
